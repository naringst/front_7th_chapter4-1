(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e){if(t.type!==`childList`)continue;for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();const e={},t=t=>{let n=e[t.type];if(n)for(let[e,r]of Object.entries(n)){let n=t.target.closest(e);if(n)try{r(t)}catch(t){console.error(`이벤트 핸들러 실행 오류 (${e}):`,t)}}},n=(()=>()=>{Object.keys(e).forEach(e=>{document.body.addEventListener(e,t)})})(),r=(t,n,r)=>{e[t]||(e[t]={}),e[t][n]=r},i=(e=200)=>{let t=window.pageYOffset||document.documentElement.scrollTop,n=window.innerHeight,r=document.documentElement.scrollHeight;return t+n>=r-e},a=e=>{let t=!1;return(...n)=>{t||(t=!0,queueMicrotask(()=>{t=!1,e(...n)}))}},o={SET_PRODUCTS:`products/setProducts`,ADD_PRODUCTS:`products/addProducts`,SET_LOADING:`products/setLoading`,SET_ERROR:`products/setError`,SET_CATEGORIES:`products/setCategories`,SET_CURRENT_PRODUCT:`products/setCurrentProduct`,SET_RELATED_PRODUCTS:`products/setRelatedProducts`,RESET_FILTERS:`products/resetFilters`,SETUP:`products/setup`,SET_STATUS:`products/setStatus`},s={ADD_ITEM:`cart/addItem`,REMOVE_ITEM:`cart/removeItem`,UPDATE_QUANTITY:`cart/updateQuantity`,CLEAR_CART:`cart/clearCart`,TOGGLE_SELECT:`cart/toggleSelect`,SELECT_ALL:`cart/selectAll`,DESELECT_ALL:`cart/deselectAll`,REMOVE_SELECTED:`cart/removeSelected`,LOAD_FROM_STORAGE:`cart/loadFromStorage`,SYNC_TO_STORAGE:`cart/syncToStorage`},c={OPEN_CART_MODAL:`ui/openCartModal`,CLOSE_CART_MODAL:`ui/closeCartModal`,SET_GLOBAL_LOADING:`ui/setGlobalLoading`,SHOW_TOAST:`ui/showToast`,HIDE_TOAST:`ui/hideToast`},l=()=>{let e=new Set,t=t=>e.add(t),n=()=>e.forEach(e=>e());return{subscribe:t,notify:n}},u=(e,t)=>{let{subscribe:n,notify:r}=l(),i=t,a=()=>i,o=t=>{let n=e(i,t);n!==i&&(i=n,r())};return{getState:a,dispatch:o,subscribe:n}},d=(e,t)=>{let n=t??(typeof window<`u`?window.localStorage:null),r=()=>{try{let t=n?.getItem(e);return t?JSON.parse(t??`null`):null}catch(t){return console.error(`Error parsing storage item for key "${e}":`,t),null}},i=t=>{try{n?.setItem(e,JSON.stringify(t))}catch(t){console.error(`Error setting storage item for key "${e}":`,t)}},a=()=>{try{n?.removeItem(e)}catch(t){console.error(`Error removing storage item for key "${e}":`,t)}};return{get:r,set:i,reset:a}},f=typeof window>`u`;var p=class e{#routes;#route;#observer=l();#baseUrl;#currentUrl=`/`;#currentSearch=``;constructor(e=``){this.#routes=new Map,this.#route=null,this.#baseUrl=e.replace(/\/$/,``),f||window.addEventListener(`popstate`,()=>{this.#route=this.#findRoute(),this.#observer.notify()})}setServerUrl(e,t=``){this.#currentUrl=e,this.#currentSearch=t}get baseUrl(){return this.#baseUrl}get query(){let t=f?this.#currentSearch:window.location.search;return e.parseQuery(t)}set query(t){let n=e.getUrl(t,this.#baseUrl);this.push(n)}get params(){return this.#route?.params??{}}get route(){return this.#route}get target(){return this.#route?.handler}subscribe(e){this.#observer.subscribe(e)}addRoute(e,t){let n=[],r=e.replace(/:\w+/g,e=>(n.push(e.slice(1)),`([^/]+)`)).replace(/\//g,`\\/`),i=RegExp(`^${this.#baseUrl}${r}$`);this.#routes.set(e,{regex:i,paramNames:n,handler:t})}#findRoute(e=``){let t=e||(f?this.#currentUrl:window.location.pathname),n=f?`http://localhost`:window.location.origin,{pathname:r}=new URL(t,n);for(let[e,t]of this.#routes){let n=r.match(t.regex);if(n){let r={};return t.paramNames.forEach((e,t)=>{r[e]=n[t+1]}),{...t,params:r,path:e}}}return null}push(e){if(!f)try{let t=e.startsWith(this.#baseUrl)?e:this.#baseUrl+(e.startsWith(`/`)?e:`/`+e),{pathname:n,search:r}=new URL(t,window.location.origin),i=`${window.location.pathname}${window.location.search}`,a=`${n}${r}`;i!==a&&window.history.pushState(null,``,a),this.#route=this.#findRoute(a),this.#observer.notify()}catch(e){console.error(`라우터 네비게이션 오류:`,e)}}start(){this.#route=this.#findRoute(),this.#observer.notify()}static parseQuery=(e=``)=>{!e&&!f&&(e=window.location.search);let t=f?`http://localhost`:window.location.origin,{search:n}=new URL(e,t),r=new URLSearchParams(n),i={};for(let[e,t]of r)i[e]=decodeURIComponent(t);return i};static stringifyQuery=e=>{let t=new URLSearchParams;for(let[n,r]of Object.entries(e))r!=null&&r!==``&&t.set(n,String(r));return t.toString()};static getUrl=(t,n=``)=>{if(f)return``;let r=e.parseQuery(),i={...r,...t};Object.keys(i).forEach(e=>{(i[e]===null||i[e]===void 0||i[e]===``)&&delete i[e]});let a=e.stringifyQuery(i);return`${n}${window.location.pathname.replace(n,``)}${a?`?${a}`:``}`};matchRoute(e){return this.#route=this.#findRoute(e),this.#route}};const m={products:[],totalCount:0,currentProduct:null,relatedProducts:[],loading:!0,error:null,status:`idle`,categories:{}},h=(e,t)=>{switch(t.type){case o.SET_STATUS:return{...e,status:t.payload};case o.SET_CATEGORIES:return{...e,categories:t.payload,loading:!1,error:null,status:`done`};case o.SET_PRODUCTS:return{...e,products:t.payload.products,totalCount:t.payload.totalCount,loading:!1,error:null,status:`done`};case o.ADD_PRODUCTS:return{...e,products:[...e.products,...t.payload.products],totalCount:t.payload.totalCount,loading:!1,error:null,status:`done`};case o.SET_LOADING:return{...e,loading:t.payload};case o.SET_ERROR:return{...e,error:t.payload,loading:!1,status:`done`};case o.SET_CURRENT_PRODUCT:return{...e,currentProduct:t.payload,loading:!1,error:null,status:`done`};case o.SET_RELATED_PRODUCTS:return{...e,relatedProducts:t.payload,status:`done`};case o.SETUP:return{...e,...t.payload};default:return e}},g=u(h,m),_=d(`shopping_cart`),v={items:[],selectedAll:!1},y=(e,t)=>e.find(e=>e.id===t),ee=(e,t)=>{let n=_?.get()??v;switch(t.type){case s.ADD_ITEM:{let{product:e,quantity:r=1}=t.payload,i=y(n.items,e.productId);if(i)return{...n,items:n.items.map(t=>t.id===e.productId?{...t,quantity:t.quantity+r}:t)};{let t={id:e.productId,title:e.title,image:e.image,price:parseInt(e.lprice),quantity:r,selected:!1};return{...n,items:[...n.items,t]}}}case s.REMOVE_ITEM:return{...n,items:n.items.filter(e=>e.id!==t.payload)};case s.UPDATE_QUANTITY:{let{productId:e,quantity:r}=t.payload;return{...n,items:n.items.map(t=>t.id===e?{...t,quantity:Math.max(1,r)}:t)}}case s.CLEAR_CART:return{...n,items:[],selectedAll:!1};case s.TOGGLE_SELECT:{let e=t.payload,r=n.items.map(t=>t.id===e?{...t,selected:!t.selected}:t),i=r.length>0&&r.every(e=>e.selected);return{...n,items:r,selectedAll:i}}case s.SELECT_ALL:{let e=n.items.map(e=>({...e,selected:!0}));return{...n,items:e,selectedAll:!0}}case s.DESELECT_ALL:{let e=n.items.map(e=>({...e,selected:!1}));return{...n,items:e,selectedAll:!1}}case s.REMOVE_SELECTED:return{...n,items:n.items.filter(e=>!e.selected),selectedAll:!1};case s.LOAD_FROM_STORAGE:return{...n,...t.payload};default:return n}},b=u(ee,v),x={cartModal:{isOpen:!1},globalLoading:!1,toast:{isVisible:!1,message:``,type:`info`}},S=(e,t)=>{switch(t.type){case c.OPEN_CART_MODAL:return{...e,cartModal:{isOpen:!0}};case c.CLOSE_CART_MODAL:return{...e,cartModal:{isOpen:!1}};case c.HIDE_TOAST:return{...e,toast:{...e.toast,isVisible:!1}};case c.SHOW_TOAST:return{...e,toast:{isVisible:!0,message:t.payload.message,type:t.payload.type||`info`}};default:return e}},C=u(S,x),w=`/front_7th_chapter4-1/vanilla/`,T=new p(w),E=(e,t)=>(t.forEach(t=>{e.addRoute(t.path,t)}),e),D=new WeakMap,O={current:null,previous:null},k={mount:null,unmount:null,watches:[],deps:[],mounted:!1},A=e=>(D.has(e)||D.set(e,{...k}),D.get(e)),te=(e,t)=>!Array.isArray(e)||!Array.isArray(t)?!1:e.length===t.length?e.some((e,n)=>e!==t[n]):!0,ne=e=>{let t=A(e);t.mounted||(t.mount?.(),t.mounted=!0,t.deps=[])},re=e=>{let t=A(e);t.mounted&&=(t.unmount?.(),!1)},j=({onMount:e,onUnmount:t,watches:n}={},r)=>{if(typeof window>`u`)return r;let i=A(r);return typeof e==`function`&&(i.mount=e),typeof t==`function`&&(i.unmount=t),Array.isArray(n)&&(i.watches=typeof n[0]==`function`?[n]:n),(...e)=>{let t=O.current!==r;return O.current&&t&&re(O.current),O.previous=O.current,O.current=r,t?ne(r):i.watches&&i.watches.forEach(([e,t],n)=>{let r=e();te(r,i.deps[n])&&t(),i.deps[n]=Array.isArray(r)?[...r]:[]}),r(...e)}};function ie(e){let{productId:t,title:n,image:r,lprice:i,brand:a}=e,o=Number(i);return`
  ...
  `}const M=typeof window>`u`?`http://localhost:5173`:``;async function N(e={}){let{limit:t=20,search:n=``,category1:r=``,category2:i=``,sort:a=`price_asc`}=e,o=e.current??e.page??1,s=new URLSearchParams({page:o.toString(),limit:t.toString(),...n&&{search:n},...r&&{category1:r},...i&&{category2:i},sort:a}),c=await fetch(`${M}/api/products?${s}`);return await c.json()}async function P(e){let t=await fetch(`${M}/api/products/${e}`);return await t.json()}async function F(){let e=await fetch(`${M}/api/categories`);return await e.json()}const I=async()=>{T.query={current:void 0},g.dispatch({type:o.SETUP,payload:{...m,loading:!0,status:`pending`}});try{let[{products:e,pagination:{total:t}},n]=await Promise.all([N(T.query),F()]);g.dispatch({type:o.SETUP,payload:{products:e,categories:n,totalCount:t,loading:!1,status:`done`}})}catch(e){throw g.dispatch({type:o.SET_ERROR,payload:e.message}),e}},L=async(e=!0)=>{try{g.dispatch({type:o.SETUP,payload:{loading:!0,status:`pending`,error:null}});let{products:t,pagination:{total:n}}=await N(T.query),r={products:t,totalCount:n};if(e){g.dispatch({type:o.SET_PRODUCTS,payload:r});return}g.dispatch({type:o.ADD_PRODUCTS,payload:r})}catch(e){throw g.dispatch({type:o.SET_ERROR,payload:e.message}),e}},R=async()=>{let e=g.getState(),t=e.products.length<e.totalCount;!t||e.loading||(T.query={current:Number(T.query.current??1)+1},await L(!1))},z=e=>{T.query={search:e,current:1}},B=e=>{T.query={...e,current:1}},he=e=>{T.query={sort:e,current:1}},ge=e=>{T.query={limit:e,current:1}},V=async e=>{try{let t=g.getState().currentProduct;if(e===t?.productId){t.category2&&await H(t.category2,e);return}g.dispatch({type:o.SETUP,payload:{...m,currentProduct:null,loading:!0,status:`pending`}});let n=await P(e);g.dispatch({type:o.SET_CURRENT_PRODUCT,payload:n}),n.category2&&await H(n.category2,e)}catch(e){throw console.error(`상품 상세 페이지 로드 실패:`,e),g.dispatch({type:o.SET_ERROR,payload:e.message}),e}},H=async(e,t)=>{try{let n={category2:e,limit:20,page:1},r=await N(n),i=r.products.filter(e=>e.productId!==t);g.dispatch({type:o.SET_RELATED_PRODUCTS,payload:i})}catch(e){console.error(`관련 상품 로드 실패:`,e),g.dispatch({type:o.SET_RELATED_PRODUCTS,payload:[]})}},_e=()=>{try{let e=_.get();e&&b.dispatch({type:s.LOAD_FROM_STORAGE,payload:e})}catch(e){console.error(`장바구니 로드 실패:`,e)}},U=()=>{try{let e=b.getState();_.set(e)}catch(e){console.error(`장바구니 저장 실패:`,e)}},W=(e,t=1)=>{b.dispatch({type:s.ADD_ITEM,payload:{product:e,quantity:t}}),U(),C.dispatch({type:c.SHOW_TOAST,payload:{message:`장바구니에 추가되었습니다`,type:`success`}}),setTimeout(()=>{C.dispatch({type:c.HIDE_TOAST})},3e3)},ve=e=>{b.dispatch({type:s.REMOVE_ITEM,payload:e}),U()},G=(e,t)=>{b.dispatch({type:s.UPDATE_QUANTITY,payload:{productId:e,quantity:t}}),U()},ye=e=>{b.dispatch({type:s.TOGGLE_SELECT,payload:e}),U()},K=()=>{b.dispatch({type:s.SELECT_ALL}),U()},q=()=>{b.dispatch({type:s.DESELECT_ALL}),U()},J=()=>{b.dispatch({type:s.REMOVE_SELECTED}),U(),C.dispatch({type:c.SHOW_TOAST,payload:{message:`선택된 상품들이 삭제되었습니다`,type:`info`}}),setTimeout(()=>{C.dispatch({type:c.HIDE_TOAST})},3e3)},Y=()=>{b.dispatch({type:s.CLEAR_CART}),U(),C.dispatch({type:c.SHOW_TOAST,payload:{message:`장바구니가 비워졌습니다`,type:`info`}}),setTimeout(()=>{C.dispatch({type:c.HIDE_TOAST})},3e3)},X=({headerLeft:e,children:t})=>{let n=b?.getState(),{cartModal:r,toast:i}=C?.getState()??{},a=n?.items?.length??0,o=`
  ...
  `},be=j({onMount:()=>{I()},watches:[()=>{let{search:e,limit:t,sort:n,category1:r,category2:i}=T.query;return[e,t,n,r,i]},()=>L(!0)]},e=>{let t=e??g.getState(),n=e?.query||T.query,{search:r,limit:i,sort:a,category1:o,category2:s}=n,{products:c,loading:l,error:u,totalCount:d,categories:f}=t,p={category1:o,category2:s},m=c.length<d;return X({headerLeft:`<h1 class="text-xl font-bold text-gray-900">
          <a href="/" data-link>쇼핑몰</a>
        </h1>`,children:`
        <!-- 검색 및 필터 -->
        ${se({searchQuery:r,limit:i,sort:a,category:p,categories:f})}
        
        <!-- 상품 목록 -->
        <div class="mb-6">
          ${le({products:c,loading:l,error:u,totalCount:d,hasMore:m})}
        </div>
      `.trim()})}),xe=({error:e})=>`
...
`;function Se({product:e,relatedProducts:t=[]}){let{productId:n,title:r,image:i,lprice:a,brand:o,description:s=``,rating:c=0,reviewCount:l=0,stock:u=100,category1:d,category2:f}=e,p=Number(a),m=[];return d&&m.push({name:d,category:`category1`,value:d}),f&&m.push({name:f,category:`category2`,value:f}),`
    ...
    `:``}
  `}const Ce=j({onMount:()=>{V(T.params.id)},watches:[()=>[T.params.id],()=>V(T.params.id)]},e=>{let t=g.getState(),n=e?.product||t.currentProduct,r=e?.relatedProducts||t.relatedProducts||[],{error:i,loading:a}=t;return X({headerLeft:`<div class="flex items-center space-x-3">
          <button onclick="window.history.back()" 
...
`:i&&!n?xe({error:i}):Se({product:n,relatedProducts:r})})}),we=()=>X({headerLeft:pe(),children:`<div class="text-center my-4 py-20 shadow-md p-6 bg-white rounded-lg">
